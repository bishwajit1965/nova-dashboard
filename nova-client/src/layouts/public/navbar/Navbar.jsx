      ...
      <div className="navbar dark:bg-slate-900">
        ...
        <div className="navbar-end dark:bg-slate-900">
          <div className="dropdown dropdown-bottom dropdown-end">
            ...
            >
              <div className="flex items-center lg:w-56 w-56">
                {user ? (
                  user.photoURL ? (
                    <>
            ...
            <ul
              tabIndex={0}
              className="dropdown-content z-[1] p-2 mt-3 shadow bg-base-100 dark:bg-slate-900 rounded-md w- space-y-2"
            >
              {user ? (
                <>
          ...
          <div className="dropdown-content flex justify-end items-centers">
            {user ? (
              <button
